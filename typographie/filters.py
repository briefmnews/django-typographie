...
re_exponent = [
    (re.compile(r"(^|\s)([1I])(er)(\s)"), "\\1\\2<sup>\\3</sup>&zwnj;"),
    (re.compile(r"(^|\s)([1I])(er)(\.|,|$)"), "\\1\\2<sup>\\3</sup>\\4"),
    (re.compile(r"(^|\s)([1-9]\d{0,2})(e)(\.|,|$)"), "\\1\\2<sup>\\3</sup>\\4"),
    (re.compile(r"(^|\s)([1-9]\d{0,2})(e)(\s)"), "\\1\\2<sup>\\3</sup>&zwnj;"),
    (re.compile(r"(^|\s)([XIV]{1,5})(e)(\.|,|$)"), "\\1\\2<sup>\\3</sup>\\4"),
    (re.compile(r"(^|\s)([XIV]{1,5})(e)(\s)"), "\\1\\2<sup>\\3</sup>&zwnj;"),
]
specific_words = [
    r"(CAC)(\s)(40)",
    r"(Europe)(\s)(1)",
...
re_parse_content = re.compile(
    r"(.*?<[^>]* ?)((?:div|p|pre|blockquote|h[1-6]|ul))( ?[^>]*>)(.*?)(</\2>.*?)",
    flags=re.S + re.U,
)
